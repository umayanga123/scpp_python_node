...
from src.utils.crypto_utils import get_pubkey, sign_senz, init_keys
from src.utils.senz_parser import parse
...
if __name__ == '__main__':
    ...
    logger.info(_('Starting the SCPP Miner-M2 Application..!'))
